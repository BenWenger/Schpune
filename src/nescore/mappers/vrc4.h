namespace schcore{ namespace mpr {
    ...
    class Vrc4 : public VrcIrq_Mapper
    {
    public:
        Vrc4()
        {}
    ...
    protected:
        ...
        virtual void cartReset(const ResetInfo& info) override
        {
            ...
            if(info.hardReset)
            {
                ...
                info.cpuBus->addWriter(0x8,0xF,this,&Vrc4::onWrite);
            }
        }
    ...
    private:
        ...
        void onWrite(u16 a, u8 v)
        {
            ...
            case 0xF000:    writeIrqLatch_lo(v & 0x0F);         break;
            case 0xF001:    writeIrqLatch_hi(v & 0x0F);         break;
            case 0xF002:    writeIrqControl(v);                 break;
            case 0xF003:    writeIrqAcknowledge();              break;
            }
        }
